...
class RPNHead(nn.Module):
    def __init__(self, out_channels=256):
        ...
        self.rpn = RegionProposalNetwork(anchor_generator=self.anchor_generator,
                                         head=self.head,
                                         fg_iou_thresh=0.7,
                                         bg_iou_thresh=0.3,
...
class ROIHead(nn.Module):
    def __init__(self, featmap_names, out_channels=256, num_classes=2):
        super().__init__()
        ...
        self.roi_heads = RoIHeads(box_roi_pool=self.pool,
